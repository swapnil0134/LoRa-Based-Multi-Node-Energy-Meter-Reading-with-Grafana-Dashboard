...
influxdb_org = 'smdh'
influxdb_bucket = 'Energy_Meter_Device_4'
...
def write_to_influxdb(timestamp, message):
    ...
    point = Point("sensor_data").tag("device", "Device4").time(timestamp, WritePrecision.S)
...
def receive_message():
    ...
    if packet is not None:
        ...
        # Check if the message contains the keyword "Device4"
        if "Device4" in packet_text:
            ...
            print("Received packet does not contain 'Device4'. Ignoring.")
