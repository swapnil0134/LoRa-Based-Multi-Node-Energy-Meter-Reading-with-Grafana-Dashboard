// Different LoRa Parameters Configured to avoid interference between two setups. Complete code. Hidden Key =Device3
...
////      Serial.println(message);
      ...
      // Check if the message matches "Device3"
      if (message == "Device3") {
////        Serial.println("Keyword 'Device3' found.");
...
void sendToLoRa(float P1, float P2, float P3, float P4, float P5, float P6, float P7, float P8, float P9, float P10, float P11, float P12, float P13, float P14, float P15, float P16, float P17) {
  ...
  String dataToSend = "ID:Device3, P1:" + String(P1) +
                      ", P2:" + String(P2) +
                      ", P3:" + String(P3) +
                      ", P4:" + String(P4) +
                      ", P5:" + String(P5) +
